...
public class PlaceOrderFormController implements Initializable {
    ...
    private void loadNextOrderId() {
        try {
            String OrderID = OrderCrud.generateNextOrderId();
    ...
    private void loadCustomerId() {
        try {
            ...
            ArrayList<String> idList = (ArrayList<String>) CustomerCrudController.getCustomerIDs();
    ...
    private void loadItemId() {
        try {
            ObservableList<String> observableList = FXCollections.observableArrayList();
            ArrayList<String> itemList = (ArrayList<String>) ItemCrudController.getItemIds();
    ...
    public void cmbCustomerOnAction(ActionEvent actionEvent) {
        ...
        try {
            Customer customer = AddCustomerFormController.search(code);
    ...
    private void fillItemFields(Customer customer) {
        ...
        txtCustomerAddress.setText(customer.getCustomer_Address());
    ...
    public void cmbItemOnAction(ActionEvent event) {
        ...
        try {
            Item item = AddItemFormController.search(code);
            fillItemFields(item);
            txtReqQty.requestFocus();
        } catch (SQLException | ClassNotFoundException e) {
            throw new RuntimeException(e);
    ...
    private void fillItemFields(Item item) {
        ...
        txtQtyOnHand.setText(String.valueOf(item.getItem_Qty()));
        txtDescription.setText(String.valueOf(item.getItem_Name()));
    }
    ...
    public void btnPlaceOrderOnAction(ActionEvent actionEvent) throws SQLException {
        ...
        try {
            ...
            boolean isOrderSaved = new OrderCrud().saveOrder(orders);
            if (isOrderSaved) {
                boolean isDetailsSaved = new OrderCrud().saveOrderDetails(details);
                if (isDetailsSaved) {
                    connection.commit();
    ...
    private void printReport() {
        ...
        hashMap.put("customerPay", txtCustomerPay.getText());
        hashMap.put("name",txtCustomerName.getText());
        hashMap.put("balance", lblBalance.getText());
        try {
